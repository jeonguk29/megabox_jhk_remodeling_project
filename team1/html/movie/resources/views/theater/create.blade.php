...
<form name="form1" method="post" action="{{ route('theater.store') }}{{ $tmp }}" enctype="multipart/form-data">
@csrf
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="location" size="20" maxlength="20" value="{{ old('location') }}"
