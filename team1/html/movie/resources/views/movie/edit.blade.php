...
<table class="table table-bordered table-sm mymargin5">
    ...
    <tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="rating" size="20" maxlength="20" value="{{ $row->rating }}"
                         class="form-control form-control-sm">
            </div>
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="playingtime" size="20" maxlength="20" value="{{ $row->playingtime }}"
                         class="form-control form-control-sm">
            </div>
        ...
        <td width="80%" align="left">
            <div class="form-inline">
				<div class="input-group input-group-sm date" id="release_date">
					<input type="text" name="release_date" size="10" value="{{$row->release_date}}" class="form-control form-control-sm">
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="publisher" size="20" maxlength="20" value="{{ $row->publisher }}"
                         class="form-control form-control-sm">
            </div>
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="video" size="1000" maxlength="1000" value="{{ $row->video }}"
                         class="form-control form-control-sm">
            </div>
        </td>
    </tr>
