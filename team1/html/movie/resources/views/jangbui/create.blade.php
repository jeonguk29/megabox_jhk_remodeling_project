...
<form name="form1" method="post" action="{{ route('jangbui.store') }}{{ $tmp }}" enctype="multipart/form-data">
@csrf
<table class="table table-bordered table-sm mymargin5">
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="hidden" name="reserveds_id" value="{{old('reserveds_id')}}" class="form-control form-control-sm" readonly>
				<input type="text" name="reserveds_uid" value="{{old('reserveds_uid')}}" class="form-control form-control-sm" readonly> &nbsp;
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_movie" value="{{old('reserveds_movie')}}" class="form-control form-control-sm" readonly>
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_theater" value="{{old('reserveds_theater')}}" class="form-control form-control-sm" readonly>
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_room" value="{{old('reserveds_room')}}" class="form-control form-control-sm" readonly>
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_date" value="{{old('reserveds_date')}}" class="form-control form-control-sm" readonly>
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_time" value="{{old('reserveds_time')}}" class="form-control form-control-sm" readonly>
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	<tr>
        ...
        <td width="80%" align="left">
            <div class="d-inline-flex">
				<input type="text" name="reserveds_price" value="{{old('reserveds_price')}}" class="form-control form-control-sm" readonly onChange="cal_prices();">
				<!--<input type="text" name="product_name42" value="" class="form-control form-control-sm" readonly>&nbsp;-->
            </div>
        </td>
	</tr>
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="total_price" size="20" maxlength="20" value="{{ old('total_price') }}"
