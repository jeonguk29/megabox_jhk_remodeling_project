...
<html lang="en" class="no-js">
	...
	<body>
		...
		<div class="container">
			<div class="cube">
				...
				<div class="cube__side cube__side--back">
					<div class="screen">
						<div class="video">
							<video class="video-player" src="{{ asset('user/media/sintel.mp4') }}" preload="auto" poster="{{ asset('user/media/sintel.jpg') }}">
								<source src="{{ asset('user/media/sintel.ogg') }}" type='video/ogg; codecs="theora, vorbis"'>
								<source src="{{ asset('user/media/sintel.mp4') }}" type='video/mp4; codecs="avc1.4D401E, mp4a.40.2"'>
		...
		<div class="plan">
			...
			@foreach ($rooms_list as $row)
				{{ $row -> room_name }} | {{ $row -> reserved_room_id }} "</br>"
			@endforeach
			
			
			<a href="./payment.html"><button class="action action--buy">Buy tickets</button></a>
		</div><!-- /plan -->
		<a href="./payment.html"><button class="action action--lookaround action--disabled" arial-label="Unlook View"></button></a>
