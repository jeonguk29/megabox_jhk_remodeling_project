...
<form name="form1" method="post" action="{{ route('playing_time.store') }}{{ $tmp }}" enctype="multipart/form-data">
@csrf
<table class="table table-bordered table-sm mymargin5">
	...
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="playing_time" size="20" maxlength="20" value="{{ old('playing_time') }}"
