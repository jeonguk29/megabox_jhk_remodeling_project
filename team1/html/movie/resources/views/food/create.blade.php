...
<form name="form1" method="post" action="{{ route('food.store') }}{{ $tmp }}" enctype="multipart/form-data">
@csrf
<table class="table table-bordered table-sm mymargin5">
	<tr>
        ...
        <td width="80%" align="left">
            <div class="fd-inline-flex">
                <input  type="text" name="subname" size="20" maxlength="20" value="{{ old('subname') }}"
                         class="form-control form-control-sm">
            </div>
