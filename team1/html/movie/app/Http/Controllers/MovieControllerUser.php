...
use Image;
class MovieControllerUser extends Controller
{
    /**
	 ...
	 public function index()
    {
		...
		return view('movieuser.index', $data);
        //
    }
    ...
    public function create()
    {
        ...
        return view('movieuser.create', $data);
    }
    ...
    public function edit($id)
    {
		...
		return view('movieuser.edit', $data );   // 수정화면 호출
    }
    ...
    public function destroy($id)
    {
		...
		$tmp = $this->qstring();
		return redirect('movieuser'.$tmp); // 다시 멤버 클레스로 가라 첫번째 실행은 index라 메인 페이지 보임
    }
